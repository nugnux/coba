...
ax.set_ylim([-1, 1])
st.pyplot(fig)
st.caption("Titik dengan ukuran dan warna acak dan tersebar didalam lingkaran dengan radius 1")
st.divider()
st.text("Buat websiti seperti di atas dengan menggunakan GitHub dan Streamlit, kirim video saat website dijalankan, pastikan nama dan alamat website terlihat")
